classdef constants
    ...
    properties
        ...
        resend_tol = 5;             % [Tunable param] How many resends we allow in total
    end
    ...
    methods(Static)
        function this=constants()
            ...
            %  the power series of P_resend raisde to 0-th, 1-st, ...,
            %  infinty power. Here we do 0 to 10 as an approximation
