...
% Group 1:
name_1 = 'Group 1';
tra_1_test = @send_yiheng;
rec_1_test = @reci_yiheng;
tra_1_fight = @send_yiheng;
rec_1_fight = @reci_yiheng;
tra_1_co_op = @send_yiheng;
rec_1_co_op = @reci_yiheng;

% Group 2:
name_2 = 'Group 2';
tra_2_test = @send_yiheng;
rec_2_test = @reci_yiheng;
tra_2_fight = @send_yiheng;
rec_2_fight = @reci_yiheng;
tra_2_co_op = @send_yiheng;
rec_2_co_op = @reci_yiheng;

% Group 3:
name_3 = 'Group 3';
tra_3_test = @send_yiheng;
rec_3_test = @reci_yiheng;
tra_3_fight = @send_yiheng;
rec_3_fight = @reci_yiheng;
tra_3_co_op = @send_yiheng;
rec_3_co_op = @reci_yiheng;

% Group 4:
name_4 = 'Group 4';
tra_4_test = @send_yiheng;
rec_4_test = @reci_yiheng;
tra_4_fight = @send_yiheng;
rec_4_fight = @reci_yiheng;
tra_4_co_op = @send_yiheng;
rec_4_co_op = @reci_yiheng;
